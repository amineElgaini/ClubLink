    ...
    <?php else: ?>
        <div class="clubs-grid">
            ...
            <div class="club-card">
                ...
                <!-- Update Form -->
                <form method="POST" action="/admin/clubs/<?= $club['id'] ?>/update" class="update-form">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="submit" class="btn btn-delete" formaction="/admin/clubs/<?= $club['id'] ?>/delete" onclick="return confirm('Are you sure you want to delete this club?')">Delete</button>
                    </div>
                </form>
            </div>
            <?php endforeach; ?>
